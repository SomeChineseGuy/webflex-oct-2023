...
When defining columns for the tables you will need to specify the data type. `SERIAL, INTEGER, VARCHAR, TEXT, BOOLEAN, DATE, TIMESTAMP, TIMESTAMPZ` are common examples.
